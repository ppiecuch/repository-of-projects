...
public:
	...
	HTAB GetTabWithWindowID(int id, HPANE *pane/*out*/) const;	// get tab whose window has 'id'.
...
private:
	...
	bool LoadStateInner(CArchive *ar, HPANE parent, Tabs const *tabs, bool ignoreLack, std::list<HPANE> *panes) throw(std::bad_alloc);
