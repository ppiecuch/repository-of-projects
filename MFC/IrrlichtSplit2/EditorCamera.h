#pragma once
#ifndef __EDITOR_CAMERA__ 
#define __EDITOR_CAMERA__ 
...
class EditorCamera : public ICameraSceneNode 
{ 
   public: 
      EditorCamera(IrrlichtDevice* devicepointer,ISceneNode* parent,ISceneManager* smgr,s32 id, 
     ...
     virtual bool getTargetAndRotationBinding() const {return 0;} 
      ...
      void pointCameraAtNode(ISceneNode* selectednode, s32 distance = 200); 
