...
namespace MyGUI
{
	...
	void WidgetInput::registerPressHandler(delegates::IDelegate1<Widget*>* h)
	{
		mEventScriptPressed = h;
	}
	void WidgetInput::registerReleaseHandler(delegates::IDelegate1<Widget*>* h)
	{
		mEventScriptReleased = h;
	}
