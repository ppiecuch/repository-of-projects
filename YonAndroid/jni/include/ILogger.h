...
namespace debug{
	...
	public:
		...
		virtual void drawString(const video::IVideoDriver* driver,const core::stringc& str,const core::position2di& pos=core::ORIGIN_VECTOR2DI,const video::SColor& color=video::COLOR_WHITE){}
