...
namespace MyGUI
{
	...
	*/
	...
	typedef delegates::CDelegate1<Widget*> EventHandle_WidgetPtr;
	typedef delegates::CDelegate2<Widget*, int> EventHandle_WidgetPtrInt;
	...
	public:
		...
		*/
		...
		void registerPressHandler(delegates::IDelegate1<Widget*>* h);
		void registerReleaseHandler(delegates::IDelegate1<Widget*>* h);
	...
	protected:
		...
		EventHandle_WidgetPtr	mEventScriptPressed;
		EventHandle_WidgetPtr	mEventScriptReleased;
//		EventHandle_Void		eventScriptPressedVoid;
//		EventHandle_WidgetPtrInt	eventScriptPressdWidgetPtrInt;
