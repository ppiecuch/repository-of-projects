...
bool init(void *pJNIEnv,const c8* appPath,const c8* resPath,u32 width,u32 height){
	...
	textSystem->addText(str1,family1,core::position2di(10,50),12,video::COLOR_GREEN, text::ENUM_FONT_RENDER_MODE_ANTIALIAS);
	...
	textSystem->addText(str4,family4,core::position2di(10,110),18 ,video::COLOR_PURPLE, text::ENUM_FONT_RENDER_MODE_ANTIALIAS);
	...
	textSystem->addText(str5,family5,core::position2di(10,130),10 ,video::COLOR_YELLOW, text::ENUM_FONT_RENDER_MODE_ANTIALIAS);
	...
	family7=textSystem->getFontFamily("fzcy.ttf");
