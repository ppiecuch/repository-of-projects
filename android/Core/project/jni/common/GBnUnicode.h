#ifndef _GBNUNICODE_H_
#define _GBNUNICODE_H_
#include "datautil.h"
...
unsigned short getUn(unsigned short gb)
{
 ...
 int gb2Unicode(const char* gb,unsigned short* &unicode)
{
	//统计长度
	int len=count(gb);
	int size=strlen(gb);
	unicode=new unsigned short[len];
