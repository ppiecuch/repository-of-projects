...
BOOL CPropertyPageDlg::OnInitDialog()
{
	...
	// TODO: 在此添加额外的初始化代码
	HWND hWnd=this->nsheet.GetSafeHwnd();
	if(!hWnd)
	{
		CPage1* npage1=new CPage1();//实例化属性页
		CPage2* npage2=new CPage2();//实例化属性页

		nsheet.AddPage(npage1);
		nsheet.AddPage(npage2);
		nsheet.Create();
