...
yon_SOURCES :=   \
		...
		Yon/CImageLoaderDDS.cpp \
		Yon/CImageLoaderPKM.cpp \
		Yon/CImageLoaderKTX.cpp \
		Yon/CImageLoaderPVR.cpp \
		Yon/yon.cpp \
		YonCompressPVR/framework.cpp \
		YonCompressPVR/yon_AndroidGLView.cpp
