...
namespace MyGUI
{
	...
	inline delegates::IDelegate0* newDelegateScript_None( std::string functionName )
	{
		return new delegates::CScriptDelegate0 (functionName);
	}

	inline delegates::IDelegate1<Widget*>* newDelegateScript_WidgetPtr( std::string functionName )
	{
		return new delegates::CScriptDelegate1<Widget*> (functionName);
	}

	inline delegates::IDelegate2<Widget*, int>* newDelegateScript_WidgetPtrInt( std::string functionName )
	{
		return new delegates::CScriptDelegate2<Widget*, int> (functionName);
	}

	inline delegates::IDelegate2<Widget*, void*>* newDelegateScript_WidgetPtrVoidPtr( std::string functionName )
	{
		return new delegates::CScriptDelegate2<Widget*, void*> (functionName);
	}
