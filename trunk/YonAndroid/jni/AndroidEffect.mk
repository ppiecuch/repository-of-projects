...
yon_SOURCES :=   \
		...
		Yon/yon.cpp \
		YonEffect/BillBoard.cpp \
		YonEffect/BillBoardAmt.cpp \
		YonEffect/BoxEmiter.cpp \
		YonEffect/CircleEmiter.cpp \
		YonEffect/ParticleEmiter.cpp \
		YonEffect/ParticleSystem.cpp \
		YonEffect/PointEmiter.cpp \
		YonEffect/Sparticle.cpp \
		YonEffect/SpeEffect.cpp \
		YonEffect/SpeEffectSet.cpp \
		YonEffect/framework.cpp \
		YonEffect/yon_AndroidGLView.cpp 
