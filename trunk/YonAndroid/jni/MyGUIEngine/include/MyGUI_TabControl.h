...
namespace MyGUI
{
	...
	private:
		...
		//@Guo Huafeng refer to MyGUI_XXXTemplates.xml
		Widget* mHeaderPlace;	// father (include mControls and mEmpty)
		Widget* mControls;		// Left and Right button (include child Left and Right)
		Widget* mEmpty;			// space remain for itemButtons
	};
