...
namespace MyGUI
{
	...
	#define MYGUI_RTTI_TYPE const type_info&
	...
	public: \
		...
		static const char* getClassTypeName() { static const char* type = #Type; return type; } \
		/** Get type name as string */ \
		/** virtual const std::string& getTypeName() const { return getClassTypeName(); } */ \
		virtual const char* getTypeName() const { return getClassTypeName(); }
