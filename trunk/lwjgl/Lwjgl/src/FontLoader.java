...
public class FontLoader {
	...
	public static UnicodeFont loadAsciiFontByFile(String fontLocation, int fontSize,java.awt.Color fontColor) throws SlickException,FontFormatException, IOException {
		BufferedInputStream location = new BufferedInputStream(FontLoader.class.getClassLoader().getResourceAsStream(fontLocation));
	...
	public static UnicodeFont loadFontByFile(String fontLocation, int fontSize,
			java.awt.Color fontColor) throws SlickException,
		 ...
		 * UnicodeFont arranges the glyphs to be rendered to the backing texture
		 * as efficiently as possible. So it is best to add all the glyphs you
		 * know you will be using ahead of time.
		 */
		tFont.addAsciiGlyphs();
		tFont.addGlyphs(0x4e00, 0x9fa5);
		/*
		 * Loads the glyphs. UnicodeFont renders the glyphs to the backing
		 * texture. The font is now ready to be used.
		 */
		tFont.loadGlyphs();
		return tFont;
	}
	
	public static UnicodeFont loadAsciiFontByName(String fontName, int fontSize,java.awt.Color fontColor) throws SlickException,FontFormatException, IOException {
	...
	public static UnicodeFont loadFontByName(String fontName, int fontSize,
			java.awt.Color fontColor) throws SlickException,
			FontFormatException, IOException {
		Font font = new Font(fontName, Font.PLAIN, fontSize);
		UnicodeFont tFont = new UnicodeFont(font);
