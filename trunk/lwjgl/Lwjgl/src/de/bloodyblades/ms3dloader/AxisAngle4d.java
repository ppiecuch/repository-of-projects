...
public class AxisAngle4d implements Serializable {
	 ...
	 * 
	 * Revision 1.11 1999/10/05 07:03:50 hiranabe copyright change
	 * 
	 * Revision 1.11 1999/10/05 07:03:50 hiranabe copyright change
	 * 
	 * Revision 1.10 1999/10/05 04:52:58 hiranabe Java3D 1.2 support. addition
	 * of AxisAngle4d(Vector3d,double) constructor and set(Vvector3d,double)
	 * 
	 * Revision 1.9 1999/03/04 09:16:33 hiranabe small bug fix and copyright
	 * change
	 * 
	 * Revision 1.8 1999/02/28 05:14:57 hiranabe default constructor comment
	 * (0,0,1,0)
	 * 
	 * Revision 1.7 1998/10/14 00:49:10 hiranabe API1.1 Beta02
	 * 
	 * Revision 1.6 1998/07/27 04:28:13 hiranabe API1.1Alpha01 ->API1.1Alpha03
	 * 
	 * Revision 1.5 1998/04/17 10:30:46 hiranabe null check for equals
	 * 
	 * Revision 1.4 1998/04/09 08:18:15 hiranabe minor comment change
	 * 
	 * Revision 1.3 1998/04/09 07:04:31 hiranabe *** empty log message ***
	 * 
	...
	// helper method
	private void setFromMat(double m00, double m01, double m02, double m10, double m11, double m12, double m20,
	...
	private void setFromQuat(double x, double y, double z, double w) {
		...
		double sin_a2 = Math.sqrt(x * x + y * y + z * z); // |sin a/2|, w =
															// cos a/2
		this.angle = 2.0 * Math.atan2(sin_a2, w); // 0 <= angle <= PI ,
													// because 0 < sin_a2
		this.x = x;
		this.y = y;
		this.z = z;
	...
	/**
	 * Returns true if all of the data members of AxisAngle4d t1 are equal to
	...
	public boolean epsilonEquals(AxisAngle4d a1, double epsilon) {
		return (Math.abs(a1.x - this.x) <= epsilon) && (Math.abs(a1.y - this.y) <= epsilon)
				&& (Math.abs(a1.z - this.z) <= epsilon) && (Math.abs(a1.angle - this.angle) <= epsilon);
	}

	/**
	 * Returns a hash number based on the data values in this object. Two
	 * different AxisAngle4d objects with identical data values (ie, returns
	 * true for equals(AxisAngle4d) ) will return the same hash number. Two
