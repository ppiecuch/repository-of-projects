...
import gldemo.GLApp_DemoCamera;
...
public class GLShadowOnPlane {
    ...
    public GLShadowOnPlane(float[] lightPosition, float[] plane,
			Object shadowcolor2, GLApp_DemoCamera glAppDemoCamera, Method method) {
    	//shadowColor = shadowcolor;
		drawObjectMethod = method;
		parentApp = glAppDemoCamera;
